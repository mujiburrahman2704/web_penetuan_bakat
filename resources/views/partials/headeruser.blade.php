...
<div>
    <div class="flex flex-row justify-center space-x-4 py-2" style="background-color: rgba(213, 221, 209, 1)">
        <div class="py-6">
            <h2 class="flex justify-center font-bold text-4xl uppercase text-black">Sistem Klasifikasi Bakat Khusus Mahasiswa Jurusan TIK</h2>
            <h2 class="flex justify-center text-2xl font-mono font-semibold text-black">Menggunakan Metode Naive Bayes Classifier
            </h2>
        </div>
    </div>
</div>
