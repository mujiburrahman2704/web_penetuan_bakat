    ...
    <section id="home">
        ...
        <div class="container my-8 mx-auto">
            <div class="border rounded-lg shadow-xl mx-10">
                ...
                <form action="{{ route('updatekajur', $data->id) }}" method="POST">
                    @csrf
                            ...
                            <div class="flex-col space-y-8">
                                <div class="grid grid-cols-3 gap-2">
                                    ...
                                    <input type="text" name="nama" id="nama" value="{{ $data->nama }}"
                                        class="col-start-2 col-span-2 py-2 bg-gray-200 border-0 rounded-md" @error('nama')
                                            is-invalid                                            
                                        @enderror>
                                        @error('nama')
                                ...
                                <div class="grid grid-cols-3 gap-2">
                                    ...
                                    <input type="text" name="nim" id="nim" value='{{ $data->nim }}'
                                        class="col-start-2 col-span-2 py-2 bg-gray-200 border-0 rounded-md" @error('nim')
                                        is-invalid                                            
                                    @enderror>
                                    @error('nim')
                                    <div class="invalid-feedback">
                                ...
                                <div class="grid grid-cols-3 gap-2">
                                    ...
                                    <select name="prodi_id" id="prodi"
                                        class="col-start-2 col-span-2 py-2 bg-gray-200 border-0 rounded-md"@error('prodi_id')
                                        is-invalid                                            
                                    @enderror>
                                    @error('prodi_id')
                                    <div class="invalid-feedback">
                                ...
                                <div class="grid grid-cols-3 gap-2">
                                    ...
                                    <select name="jurusan_id" id="prodi"
                                        class="col-start-2 col-span-2 py-2 bg-gray-200 border-0 rounded-md"@error('jurusan_id')
                                        is-invalid                                            
                                    @enderror>
                                    @error('jurusan_id')
                                    <div class="invalid-feedback">
                                ...
                                <div class="grid grid-cols-3 gap-2">
                                    ...
                                    <input type="text" name="email" id="email" value="{{ $data->email }}"
                                        class="col-start-2 col-span-2 py-2 bg-gray-200 border-0 rounded-md"@error('email')
                                        is-invalid                                            
                                    @enderror>
                                    @error('email')
                                    <div class="invalid-feedback">
                            ...
                            <div class="flex-col space-y-8">
                                <div class="grid grid-cols-3 gap-2">
                                    ...
                                    <input type="text" name="nohp" id="nohp" value="{{ $data->nohp }}"
                                        class="col-start-2 col-span-2 py-2 bg-gray-200 border-0 rounded-md"@error('nohp')
                                        is-invalid                                            
                                    @enderror>
                                    @error('nohp')
                                    <div class="invalid-feedback">
                                ...
                                <div class="grid grid-cols-3 gap-2">
                                    ...
                                    <input type="text" name="alamat" id="alamat" value='{{ $data->alamat }}'
                                        class="col-start-2 col-span-2 py-2 bg-gray-200 border-0 rounded-md"@error('alamat')
                                        is-invalid                                            
                                    @enderror>
                                    @error('alamat')
                                    <div class="invalid-feedback">
                                ...
                                <div class="grid grid-cols-3 gap-2">
                                    ...
                                    <select name="jeniskelamin" id="jk"
                                        class="col-start-2 col-span-2 py-2 bg-gray-200 border-0 rounded-md"@error('jeniskelamin')
                                        is-invalid                                            
                                    @enderror>
                                    @error('jeniskelamin')
                                    <div class="invalid-feedback">
                                ...
                                <div class="grid grid-cols-3 gap-2">
                                    ...
                                    <input type="date" name="tgllahir" id="tgllahir" value="{{ $data->tgllahir }}"
                                        class="col-start-2 col-span-2 py-2 bg-gray-200 border-0 rounded-md"@error('tgllahir')
                                        is-invalid                                            
                                    @enderror>
                                    @error('tgllahir')
                                    <div class="invalid-feedback">
